package com.zhou.cart.service.impl;
...
public class CartServiceImpl implements CartService {
	...
	@Override
	public ShopResult addCart(long userId, long itemId, int num) {
		//向redis中添加购物车。
	...
	@Override
	public ShopResult mergeCart(long userId, List<TbItem> itemList) {
		//遍历商品列表
		//把列表添加到购物车。
		//判断购物车中是否有此商品
		//如果有，数量相加
	...
	@Override
	public ShopResult updateCartNum(long userId, long itemId, int num) {
		//从redis中取商品信息
		String json = jedisClient.hget(REDIS_CART_PRE + ":" + userId, itemId + "");
		//更新商品数量
	...
	@Override
	public ShopResult clearCartItem(long userId) {
		//删除购物车信息
